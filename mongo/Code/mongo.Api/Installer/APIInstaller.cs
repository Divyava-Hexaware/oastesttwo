...
using mongo.Api.Filters;
using mongo.BusinessServices.Installer;

namespace mongo.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mongo API", Version = version + "-" + branch});
            });
